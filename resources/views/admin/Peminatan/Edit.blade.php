            ...
            <form action="{{ route('peminatan.update',$find->id) }}" method="post">
              ...
              @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kd_peminatan" name="kd_peminatan" value="{{ $find->kd_peminatan }}">
                  </div>
                  <div class="form-group">
                    <label for="peminatan">Peminatan</label>
                    <input type="text" class="form-control" id="peminatan" name="peminatan" value="{{ $find->peminatan }}">
                  </div>
                  <div class="form-group">
